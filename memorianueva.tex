...
El trabajo se realizó para Critical Match como parte de la expansión de sus servicios a los usuarios.

Para la implementación fueron imprescindibles conocimientos relacionados
al procesamiento de lenguaje natural y modelos extensos de lenguaje adquiridos
en la Especialización en Inteligencia Artificial de la FIUBA.
\end{abstract}

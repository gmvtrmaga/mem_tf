...
En la presente memoria se describe el diseño e implementación de un prototipo que emplea
modelos extensos de lenguaje para la asistencia de los usuarios en la generación de contenido narrativo.
El trabajo se realizó para la aplicación de Critical Match en su desarrollo de una de sus ramas de ampliación de servicios para sus usuarios.

Para su implementación fueron imprescindibles los conocimientos adquiridos en la especialización
tanto en su contenido teórico como en los procedimientos para la creación y programación de proyectos de inteligencia artificial,

...
Esta decisión se tomó al principio de la especialización en inteligencia artificial,
influenciada por la forma en la que se trabaja con modelos más sencillos.
...
Además, cuenta con varias ventanas de configuración de parámetros de lanzamiento del modelo, prompts personalizados,
...
profundizar de forma independiente en los componentes sin comprometer el funcionamiento del resto del sistema.
...
\footnote{Esto puede ser a través del formulario proporcionado por el servidor o a través de cualquier otra herramienta como,
por ejemplo, PostMan.}.
...
esta función es la encargada de construir el prompt a partir del texto extraído del fichero

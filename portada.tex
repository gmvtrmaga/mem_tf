...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Aplicación de modelos extensos de lenguaje en la ambientación narrativa} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Mario Gómez Alonso} \\[1cm]
        ...
        \textbf{Director:} Bach. Josselyn Sofía Ordóñez Olazábal} \\[1cm]
        ...
        Ciudad de Madrid, España, junio de 2025} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
